...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +9476707XXX");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://hii2-785f09ca9a56.herokuapp.com/pair?phone=${q}`);
        ...
        const doneMessage = "> *MR.NADUWA-V1 PAIR COMPLETED*";
